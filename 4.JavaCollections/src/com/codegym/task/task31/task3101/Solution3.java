...
public class Solution3 {
    public static void main(String[] args) throws IOException {
        String path = "C:\\Users\\Bogus\\Desktop\\testy"; // path to the dir
        String resultFileAbsolutePath = "C:\\Users\\Bogus\\Desktop\\noname.txt"; // full path of an existing file that will store the result
